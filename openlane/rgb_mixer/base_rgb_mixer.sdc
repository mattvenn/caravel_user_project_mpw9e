...
# Input delays
set_input_delay -max 1.87 -clock [get_clocks {clk}] [get_ports {reset}]
set_input_delay -min 0.18 -clock [get_clocks {clk}] [get_ports {reset}]

# Input Transition
set_input_transition -max 0.86  [get_ports {reset}]
set_input_transition -min 0.07  [get_ports {reset}]
